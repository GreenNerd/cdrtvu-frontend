      ...
      marker = L.mapbox.featureLayer
        ...
        features: [{
          ...
          properties:
            ...
            description: """<img style='width: 100%' src='http://7xjkjw.com1.z0.glb.clouddn.com/map-pic.jpg'/><div>四川省成都市东城根上街55号（科技大厦7楼）<a href='http://j.map.baidu.com/SPv83' target='_blank' style='color: hsl(110, 39%, 54%); font-weight: bold;'>导航</a></div><div>400-8611-7088</div>"""
            'marker-size': 'large'
            'marker-color':'#a3e46b'
